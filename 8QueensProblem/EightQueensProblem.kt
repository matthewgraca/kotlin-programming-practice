class EightQueensProblem {
     ...
     */
    public fun solve(): Array<IntArray> {
     ...
     * Prints the solution 
     */
    public fun printSolution(solvedBoard: Array<IntArray>){
      print("There are ${numOfQueens(solvedBoard)} queens on the board.")
      printBorder()
      for(i in 0 until solvedBoard.size){
          print("|  ")
          for(j in 0 until solvedBoard.size){
